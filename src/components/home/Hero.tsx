...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-teal-400 to-purple-500 dark:from-indigo-900 dark:via-teal-800 dark:to-purple-900 pt-32 lg:pt-40 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center z-10">
        <div className="text-center">
          <div className="relative z-10">
            ...
            <p className="text-xl lg:text-2xl font-bold italic" style={{ color: "#8b0000" }}>
              Electrical & Automation
            </p>
            ...
            <motion.button
              ...
              className="mt-6 px-6 py-3 rounded-lg bg-gradient-to-r from-[#ff6f61] to-[#4a0e78] text-white font-semibold shadow-md hover:from-[#4a0e78] hover:to-[#ff6f61] transition-all duration-300"
