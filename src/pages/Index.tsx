...
const Index = () => {
  ...
  <div className="flip-card group perspective-1000">
    <div className="flip-card-inner group-hover:rotate-y-180 transition-transform duration-700 ease-in-out relative w-full h-full" style={{ perspective: '1000px' }}>
      <div className="flip-card-front bg-white/30 dark:bg-gray-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-blue-400/30 group-hover:shadow-blue-400/40 transition-all duration-500 flex flex-col items-center justify-center p-7 absolute w-full h-full z-20">
        <div className="w-14 h-14 flex items-center justify-center mb-4 rounded-full bg-gradient-to-br from-blue-400/40 to-blue-200/20 dark:from-blue-400/60 dark:to-blue-900/30 shadow-lg border-2 border-blue-400/30">
  ...
  <div className="flip-card group perspective-1000">
    <div className="flip-card-inner group-hover:rotate-y-180 transition-transform duration-700 ease-in-out relative w-full h-full" style={{ perspective: '1000px' }}>
      <div className="flip-card-front bg-white/30 dark:bg-gray-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-green-400/30 group-hover:shadow-green-400/40 transition-all duration-500 flex flex-col items-center justify-center p-7 absolute w-full h-full z-20">
        <div className="w-14 h-14 flex items-center justify-center mb-4 rounded-full bg-gradient-to-br from-green-400/40 to-green-200/20 dark:from-green-400/60 dark:to-green-900/30 shadow-lg border-2 border-green-400/30">
  ...
  <div className="flip-card group perspective-1000">
    <div className="flip-card-inner group-hover:rotate-y-180 transition-transform duration-700 ease-in-out relative w-full h-full" style={{ perspective: '1000px' }}>
      <div className="flip-card-front bg-white/30 dark:bg-gray-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-red-400/30 group-hover:shadow-red-400/40 transition-all duration-500 flex flex-col items-center justify-center p-7 absolute w-full h-full z-20">
        <div className="w-14 h-14 flex items-center justify-center mb-4 rounded-full bg-gradient-to-br from-red-400/40 to-red-200/20 dark:from-red-400/60 dark:to-red-900/30 shadow-lg border-2 border-red-400/30">
  ...
  <div className="flip-card group perspective-1000">
    <div className="flip-card-inner group-hover:rotate-y-180 transition-transform duration-700 ease-in-out relative w-full h-full" style={{ perspective: '1000px' }}>
      <div className="flip-card-front bg-white/30 dark:bg-gray-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-yellow-400/30 group-hover:shadow-yellow-400/40 transition-all duration-500 flex flex-col items-center justify-center p-7 absolute w-full h-full z-20">
        <div className="w-14 h-14 flex items-center justify-center mb-4 rounded-full bg-gradient-to-br from-yellow-400/40 to-yellow-200/20 dark:from-yellow-400/60 dark:to-yellow-900/30 shadow-lg border-2 border-yellow-400/30">
  ...
  <div className="flip-card group perspective-1000">
    <div className="flip-card-inner group-hover:rotate-y-180 transition-transform duration-700 ease-in-out relative w-full h-full" style={{ perspective: '1000px' }}>
      <div className="flip-card-front bg-white/30 dark:bg-gray-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-purple-400/30 group-hover:shadow-purple-400/40 transition-all duration-500 flex flex-col items-center justify-center p-7 absolute w-full h-full z-20">
        <div className="w-14 h-14 flex items-center justify-center mb-4 rounded-full bg-gradient-to-br from-purple-400/40 to-purple-200/20 dark:from-purple-400/60 dark:to-purple-900/30 shadow-lg border-2 border-purple-400/30">
