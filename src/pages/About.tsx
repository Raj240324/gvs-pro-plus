  ...
  const timelineData = [
    {
      ...
      content: (
        <div>
          ...
          <img src="/public/assets/founded_about.jpg" alt="Founded GVS Controls" className="w-full h-40 object-cover rounded-xl shadow-md mt-4" />
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <img src="/public/assets/power_plants.jpg" alt="Early Projects" className="w-full h-40 object-cover rounded-xl shadow-md mt-4" />
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <img src="/public/assets/renewable_energy.jpg" alt="Expansion" className="w-full h-40 object-cover rounded-xl shadow-md mt-4" />
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <img src="/public/assets/automation.jpg" alt="Automation Leadership" className="w-full h-40 object-cover rounded-xl shadow-md mt-4" />
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <img src="/public/assets/clients_about.jpg" alt="Global Reach" className="w-full h-40 object-cover rounded-xl shadow-md mt-4" />
        </div>
      ),
    },
  ];
